...
import dev.cauesouza.service.CityServiceImpl;
...
public class CityResource {
    ...
    @POST
    @RolesAllowed("Admin")
    public Response persist(@RequestBody CityDTO receivedDTO) {
        try {
            CityResponseDTO entity = cityService.persist(receivedDTO);
    ...
    @Path("/{id}")
    @RolesAllowed("Admin")
    public Response update(@PathParam("id") Long id, @RequestBody CityDTO receivedDTO) {
        try {
            CityResponseDTO entity = cityService.update(id, receivedDTO);
            ;
